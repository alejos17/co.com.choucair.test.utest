...
public class UtestRegisterStep3Page extends PageObject {
    ...
    public static final Target INPUT_VERSION = Target.the("Input the Operating System Version").located(By.xpath("//*[@id=\"web-device\"]/div[2]/div[2]/div/input[1]"));
    ...
    public static final Target INPUT_LANGUAGE = Target.the("Input the Operating System Language").located(By.xpath("//*[@id=\"web-device\"]/div[3]/div[2]/div/input[1]"));
    ...
    public static final Target INPUT_MOBILEDEVICE = Target.the("Input the Mobile Brand").located(By.xpath("//*[@id=\"mobile-device\"]/div[1]/div[2]/div/input[1]"));
    ...
    public static final Target INPUT_MODEL = Target.the("Input the Mobile Model").located(By.xpath("//*[@id=\"mobile-device\"]/div[2]/div[2]/div/input[1]"));

    public static final Target CLICK_INPUT_OS = Target.the("Click in span to activate").located(By.name("handsetOSId"));
    public static final Target INPUT_OS = Target.the("Input the Mobile Operating System").located(By.xpath("//*[@id=\"mobile-device\"]/div[3]/div[2]/div/input[1]"));

    public static final Target NEXT_BUTTON = Target.the("Button to next, Register Step 4").located(By.xpath("//div[@class='pull-right next-step']//span[contains(text(),'Next: Last Step')]"));
