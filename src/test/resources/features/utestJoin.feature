...
Feature: Utest Join
  ...
  Scenario: Join to Utest Website has new user
    ...
    | strName         | strLastName       | strEmail            | strYearOfBirth  | strMonthOfBirth | strDayOfBirth | strCity   | strZipCode  | strCountry |  strComputer | strVersion    | strLanguage | strMobileDevice | strModel  | strOs   |
    | Alejandro       | Tamayo            | alejos17@gmail.com  | 1984            | February        | 17            | Manizales | 170002      | Colombia   |  macOS       | Big Sur 11.6  | Spanish     | Apple           | iPhone 7  | iOS 14.8|
